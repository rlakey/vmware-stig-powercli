...
param (
    ...
    [string]$vcenter = $hostname,
    [Parameter(Mandatory = $true)]
    [pscredential]$vccred,
    [Parameter(Mandatory = $true, ParameterSetName = "SingleHost")]
    [string]$hostname,
...
$V93949 = $false  #Lockdown Mode
$V93951 = $false  #DCUI.Access List
...
$V93975 = $false  #SSH PermitRootLogin no
