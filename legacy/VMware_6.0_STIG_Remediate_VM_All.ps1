...
.DESCRIPTION
	This script will remediate all Virtual Machines in the target vCenter for the following vSphere 6.0 STIG items:
...
.EXAMPLE
   ./VMware_6.0_STIG_Remediate_VM_All.ps1 -vcenter vcenter.test.lab
#>
...
#	"isolation.tools.autoInstall.disable" = $true;  ## VM-06-000035  Uncomment if tools auto install is not needed
