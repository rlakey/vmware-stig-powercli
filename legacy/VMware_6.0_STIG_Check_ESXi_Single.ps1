...
.DESCRIPTION
	This script will check compliance of a single ESXi Host in the target vCenter.  You will be prompted for a username and password to SSH into each host.  You will also be prompted for vCenter credentials.
...
.EXAMPLE
   ./VMware_6.0_STIG_Check_ESXi.ps1 -vcenter vcenter.test.lab -vhost esxi01.test.lab
#>
